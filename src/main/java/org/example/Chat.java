...
public class Chat implements MessageListener {
    ...
    public Chat(String topicFactory, String topicName, String username) throws
        ...
        // O cliente utiliza o TopicConnectionFactory para criar um objeto do tipoTopicConnection com o provedor JMS
        TopicConnectionFactory conFactory = (TopicConnectionFactory) ctx.lookup(topicFactory);
        // Utiliza o TopicConnectionFactory para criar a conexão com o provedorJMS
        TopicConnection connection = conFactory.createTopicConnection();
        // Utiliza o TopicConnection para criar a sessão para o produtor
        // Atributo false -> uso ou não de transações(tratar uma série deenvios/recebimentos como unidade atômica e
        // controlá-la via commit e rollback)
        // Atributo AUTO_ACKNOWLEDGE -> Exige confirmação automática apósrecebimento correto
        ...
        // Cria o tópico JMS do produtor das mensagens através da sessão e o nomedo tópico
        TopicPublisher publisher = pubSession.createPublisher(chatTopic);
        // Cria(Assina) o tópico JMS do consumidor das mensagens através da sessãoe o nome do tópico
    ...
    public void onMessage(Message message) {
        try {
            // As mensagens criadas como TextMessage devem ser recebidas comoTextMessage
    ...
    // Cria a mensagem de texto e a publica no tópico. Evento referente aoprodutor
        ...
        try {
            ...
            while (true) {
                ...
                if (s.equalsIgnoreCase("exit")) {
                    ...
                    //envia a mensagem digitada no console para o métod writeMessage que irá publica-la
                    chat.writeMessage(s);
                }
            }
        } catch (Exception e) {
